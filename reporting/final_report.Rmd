...
```{r runtime-plot, echo=FALSE, out.width='85%', fig.align='center'}
knitr::include_graphics("../gen/output/runtime_vs_rating.png")
```
...
```{r genre-plot, echo=FALSE, out.width='85%', fig.align='center'}
knitr::include_graphics("../gen/output/rating_by_genre.png")
```


Further analysis shows trends over time:

```{r year-plot, echo=FALSE, out.width='85%', fig.align='center'}
knitr::include_graphics("../gen/output/year_vs_rating.png")
```

Finally, we assess the validity of the regression model:

```{r diagnostics-plot, echo=FALSE, out.width='85%', fig.align='center'}
knitr::include_graphics("../gen/output/model_diagnostics.png")
```
